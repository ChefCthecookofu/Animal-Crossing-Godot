...
func _process(_delta):
	...
	if sky:
		...
		sky.set_shader_parameter("sky_top_color", top_color)
		sky.set_shader_parameter("sky_horizon_color", horizon_color)
		sky.set_shader_parameter("ground_bottom_color", top_color)
		sky.set_shader_parameter("ground_horizon_color", horizon_color)
